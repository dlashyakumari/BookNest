              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                  {isItemInWishlist(item._id) ? (
                    <Button
                      style={{ backgroundColor: 'red', border: 'none', flex: 1 }}
                    ...
                    <Button
                      style={{ backgroundColor: 'rebeccapurple', border: 'none', flex: 1 }}
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                  <Button style={{ backgroundColor: '#28a745', border: 'none', flex: 1 }}>
                    <Link to={`/orderitem/${item._id}`} style={{ color: 'white', textDecoration: 'none' }}>
                      Buy Now
                    </Link>
                  </Button>
                  
                  <Button style={{ backgroundColor: 'rebeccapurple', border: 'none', flex: 1 }}>
